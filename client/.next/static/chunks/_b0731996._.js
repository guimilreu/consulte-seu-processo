...
"[project]/components/client/Navbar.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ClientNavbar = ()=>{
    ...
    const { user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$user$2d$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"])();
    const handleLogout = ()=>{
        logout();
        router.push("/login");
    };
...
_s(ClientNavbar, "cDL3ooci3cL+KzbCJqktEMXmYYY=", false, function() {
    return [
...
//# sourceMappingURL=_b0731996._.js.map