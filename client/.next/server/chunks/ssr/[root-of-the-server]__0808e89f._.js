...
"[project]/store/auth-store.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AdminLoginPage = ()=>{
    ...
    const { login, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$auth$2d$store$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        if (result.success) {
            // Verifica se é admin ou team
            if (result.user.role === "admin" || result.user.role === "team") {
                router.push("/admin/dashboard");
            } else {
                // Se não for admin, redireciona para dashboard de cliente
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0808e89f._.js.map